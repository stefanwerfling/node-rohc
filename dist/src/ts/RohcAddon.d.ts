 ...
 */
export declare enum RohcProfiles {
 ...
 * @see https://rohc-lib.org/support/documentation/API/rohc-doc-2.3.1/group__rohc.html
 */
export declare enum RohcStatus {
    ROHC_OK = 0,
 ...
 */
export declare enum RohcDecompState {
 ...
 */
export declare enum RohcPacket {
    ROHC_PACKET_IR = 0,
...
declare const rohcAddon: rohcAddonTypes;
